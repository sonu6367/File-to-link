        ...
        try:
            ...
            if user.status == "kicked":
             ...
             await StreamBot.send_photo(
                ...
                caption="𝙹𝙾𝙸𝙽 CHANNEL 𝚃𝙾 𝚄𝚂𝙴 𝙼𝙴🔐 \n\n ​<b>Than just foword (Sand) your file to this bot</b>​",
...
async def help_handler(bot, message):
    ...
    if Var.UPDATES_CHANNEL != "None":
        try:
            ...
            await bot.send_message(
                chat_id=message.chat.id,
                text="__Sᴏᴍᴇᴛʜɪɴɢ ᴡᴇɴᴛ Wʀᴏɴɢ. Cᴏɴᴛᴀᴄᴛ ᴍᴇ__ [Support](https://t.me/file_to_link_bot_07).",
                disable_web_page_preview=True)
            return
...
<b> I also support Channels, add me to you Channel and send any media files and see miracle✨ also send /list to know all commands""",
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [InlineKeyboardButton("💁‍♂️ Owner", url="t.me/file_to_link_bot_07")],
                [InlineKeyboardButton("💥 Support Us", url="t.me/file_to_link_bot_07")]
            ]
        )
    )
